...
class Trainer:
    ...
    def __call__(
        ...
        for epoch_no in range(self.epochs):
            ...
            # training loop
            with tqdm(train_iter, total=total, bar_format="{desc} {percentage:3.0f}% | {n_fmt}/{total_fmt} [{elapsed}] {postfix}") as it:
            ...
            if validation_iter is not None:
                ...
                with tqdm(validation_iter, total=total, colour="green", bar_format="{desc} {percentage:3.0f}% | {n_fmt}/{total_fmt} [{elapsed}] {postfix}") as it:
